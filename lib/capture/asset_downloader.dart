...
String? detectImageMime(Uint8List b) {
  ...
  // AVIF lives here, and real webtoon CDNs serve it — omitting this rejected
...
class AssetDownloader {
  AssetDownloader({required this.browser, required this.config, Dio? dio})
    : _dio =
          dio ??
          Dio(
            BaseOptions(
  ...
  /// sites (uzaymanga panels are 800×13850..800×16000 strips with no HTML
